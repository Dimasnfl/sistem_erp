                    ...
                    foreach ($sertifikat as $key => $value) : ?>
                     <tr>
                       ...
                       <td class="text-center">
                         <a href="<?= site_url('sertifikat/edit/' . $value->id) ?>" class="btn btn-outline-warning"><i class="fas fa-pencil-alt"></i>.Edit</a>
                         <form action="<?= site_url('sertifikat/' . $value->id) ?>" method="post" class="d-inline" onsubmit="return confirm('Hapus Data Sertifikat Bernama <?= ($value->id_user) ?>?')">
