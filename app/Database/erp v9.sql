...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 14 Des 2022 pada 15.15
...
(5, 9, 4, '2022-12-14 19:38:18'),
(6, 10, 20, '2022-12-14 19:47:09'),
(7, 10, 100, '2022-12-14 20:24:21'),
(8, 10, 20, '2022-12-14 20:25:32');
...
--
DELIMITER $$
CREATE TRIGGER `delete_stok_modul` AFTER INSERT ON `moduls_out` FOR EACH ROW BEGIN
	UPDATE moduls SET ketersediaan = ketersediaan - NEW.qty
	WHERE moduls.id = NEW.id_moduls;
END
$$
...
(14, 'Dimas Naufal Hakiki', '0619101028', 'dmsnf@gmail.com', '08912312312', 3, 'A', '$2y$10$TTa9GlF13u7LZbeKmr9Vge7OqBaKKrfPsT9op0U6cuzSEOYpXPBHS', 1);
...
--
ALTER TABLE `moduls_out`
  MODIFY `id_out` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
...
--
-- AUTO_INCREMENT untuk tabel `notif_user`
--
ALTER TABLE `notif_user`
...
--
-- Ketidakleluasaan untuk tabel `notif_user`
--
ALTER TABLE `notif_user`
